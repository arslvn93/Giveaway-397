const config = {
    ...
    "includedItems": [
      {
        ...
        "text": "$100 worth of tickets to a Blue Jays game"
      },
      {
        "icon": "fas fa-baseball-ball",
        "text": "Experience the live excitement of baseball"
      },
      {
        "icon": "fas fa-users",
      ...
      {
        "icon": "fas fa-bolt",
        "text": "Quick and easy entry at our Canada Day booth"
      }
    ],
  ...
  "howToEnter": {
    ...
    "highlights": [
      {
        "icon": "fas fa-baseball-ball",
        "text": "Exciting Live Sports Experience"
      },
      {
        "icon": "fas fa-gift",
        "text": "$100 Value Prize"
      },
      {
        "icon": "fas fa-smile",
        "text": "Free to Enter!"
  ...
  "entryForm": {
    "sharePlatforms": {
      "facebook": "https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fgiveaway-397.netlify.app%2Fadmin",
      "twitter": "https://twitter.com/intent/tweet?url=https%3A%2F%2Fgiveaway-397.netlify.app%2Fadmin&text=Win%20Blue%20Jays%20tickets%20this%20Canada%20Day!"
    },
